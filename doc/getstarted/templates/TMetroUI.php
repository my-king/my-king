...
class TMetroUI extends Controller {
    ...
    public function init() {
        ...
        $this->HTML->addJavaScript(PATH_TEMPLATE_JS_URL . "load-metro.js", true); //5 a entrar
        $this->HTML->addJavaScript(PATH_TEMPLATE_JS_URL . "prettify/prettify.js", true); //4 a entrar
        ...
        $this->HTML->addCss(PATH_TEMPLATE_JS_URL . "prettify/prettify.css", true); //4 entrar
